...
from models import Informer, Autoformer, Transformer, LSTM, CNN, MLP, BiLSTM
        ...
        with torch.no_grad():
            for i, (batch_x, batch_y, batch_x_mark, batch_y_mark) in enumerate(vali_loader):
                ...
                if self.args.use_amp:
                    ...
                    if self.args.model == 'LSTM' or self.args.model == 'CNN' or self.args.model == 'MLP' or self.args.model == 'BiLSTM':
